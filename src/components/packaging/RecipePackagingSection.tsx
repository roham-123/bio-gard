...
import type {
  FormulaPackagingBasis as PackagingBasis,
  PackagingLineInput,
  PackagingRow,
} from "./types";
...
export default function RecipePackagingSection({
  packagingRows,
  grandTotal,
  packagingCostPerKg,
  ...
  const groupedMasterItems = useMemo(() => groupPackagingMasterItems(masterItems), [masterItems]);
